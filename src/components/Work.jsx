...
const Work = () => {
  return (
    <div
      name="work"
      className="w-full md:min-h-screen text-gray-300 bg-[#0a192f] py-20 "
    >
        ...
        <div className=" grid sm:grid-cols-2 md:grid-cols-3 gap-4    ">
          ...
          >
            <div className="opacity-0 group-hover:opacity-100 ">
              ...
              <div className="pt-8 text-center ">
                {/* eslint-disable-next-line */}
                <a href="https://samsonworldapp.netlify.app" target="_blank">
                  <button
                    className="text-center rounded-lg px-4 py-3 m-2
                       bg-yellow-400 text-gray-700 font-bold text-lg"
                  >
                ...
                {/* eslint-disable-next-line */}
                <a
                  href="https://github.com/samsonkaleti/world-project"
                  target="_blank"
                >
                  <button
                    className="text-center rounded-lg px-4 py-3 m-2
